...
const DownloadAquaticBacklogModal = ({
  isOpen,
  onRequestClose,
  onDownloadBacklog,
}) => {
    ...
    try {
      ...
      result.data.forEach((resultant) => {
        ...
        formattedStartDate === formattedEndDate
          ? (filename = `${workgroupId}-${formattedStartDate}-aquatic-${descriptors[i]}-backlog_data.csv`)
          : (filename = `${workgroupId}-${formattedStartDate} to ${formattedEndDate}-aquatic-${descriptors[i]}-backlog_data.csv`);
...
export default DownloadAquaticBacklogModal;
